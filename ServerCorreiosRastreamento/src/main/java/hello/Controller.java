...
public class Controller {
	 ...
	 * 
	 * get("/usuarios", (req, res) -> { List<Usuario> listaUsuario = new
	 * LinkedList<Usuario>(); listaUsuario = modelo.listarUsuarios(); return new
	 * Gson().toJson(listaUsuario); });
	 * 
	 * post("/usuarios", (request, response) -> {
	 * 
	 * response.type("application/json"); Usuario usuario = new
	 * Gson().fromJson(request.body(), Usuario.class); Boolean ret =
	...
	//public void chamados() {
		...
		/*
		 * get("/chamados", (req, res) -> { List<Chamado> listaChamado = new
		 * LinkedList<Chamado>(); listaChamado = modelo.listarChamados(); return new
		 * Gson().toJson(listaChamado); });
		 */
		
		/*
		 * get("/chamados/:numero", (req, res) -> { Chamado chamado =
		 * modelo.buscarChamado(Integer.parseInt(req.params(":numero"))); return new
		 * Gson().toJson(chamado); });
		 */
